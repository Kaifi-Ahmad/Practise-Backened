...
import { changePassword, getUser, getUserChannelProfile, getWatchHistory, logoutUser, refreshAccessToken, registerUser, updateAvatar, updateCoverImage, updateDetails, userEmailVerification, userLogin } from "../controllers/auth.controllers.js";
...
router.route("/verify-email/:verificationToken").get(validation,userEmailVerification)
